...
describe('Between Date XIRR Report', () => {
  ...
  const baseUrl = "https://wealthelite.in/MutualFund/aum-master/registrar-aum";
  const clientName = 'Abhishek Singh Parihar';
  const familyName = 'Abhishek Singh Parihar';


  // ✅ Test Case 1 — Date: Default, ARN: All
  it('TC_01:Generate AUM Report by Registar with default date and all ARN', () => {
  ...
  it('TC_021:Generate AUM Reports by Registar with selected date and selected ARN', () => {
