...
describe('Between Date XIRR Report', () => {
  ...
  const baseUrl = "https://wealthelite.in/MutualFund/aum-master/branch-aum";
  const clientName = 'Abhishek Singh Parihar';
  const familyName = 'Abhishek Singh Parihar';


  // ✅ Test Case 1 — Date: Default, ARN: All
  it('TC_01:Generate AUM Report by Branch with default date and all ARN', () => {
  ...
  it('TC_02:Generate AUM Reports by Branch with selected date and selected ARN', () => {
