...
describe('AUM Report', () => {
  ...
  const baseUrl = "https://wealthelite.in/MutualFund/aum-master/amc-aum";
  const clientName = 'Abhishek Singh Parihar';
  const familyName = 'Abhishek Singh Parihar';


  // ✅ Test Case 1 — Date: Default, ARN: All
  it('TC_01:Generate AUM Report with default date and all ARN', () => {
  ...
  it('TC_021:Generate AUM Reports with selected date and selected ARN', () => {
   ...
   it('TC_03:Generate AUM Report with selected date and all ARN', () => {
