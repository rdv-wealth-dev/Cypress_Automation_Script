describe('Mutual Fund Dashboard', () => {
    ...
    it('Validate the Report of AUM By Fund House', () => {

        // Select AUM By Fund House Tab
        cy.get('#main-content-wrapper > div > div > div:nth-child(1) > div > a').should('be.visible').click();

        // Select dates 
        cy.get('select#aumReportDate')
            .select('2024-08-18');
    
        // Select ARN
        // cy.get('select#arnNo').select('ARN-69442');
        ...
        cy.get('#amcWiseAumDatatable_wrapper > div.dataTables_scroll tbody tr')
